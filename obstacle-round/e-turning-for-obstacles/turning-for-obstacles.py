'''
This programs starts from where the basic-nav-v2 program ends, i.e start of turn, and the basic-nav-v2 picks up after this one ends. 
It ensures the robot completes the given turn.
'''
